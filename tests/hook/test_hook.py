...
def test_register_does_not_import_the_training_stack():
    ...
    script = (
        ...
        "('vllm_online_train.assembler', 'vllm_online_train.train',"
        " 'vllm_online_train.head', 'vllm_online_train.capture',"
        " 'vllm_online_train.collate', 'vllm_online_train.checkpoint'))];"
        "print(heavy)"
    )
